...
function LandingExplore() {
  ...
  return (
    <section ref={ref} className="max-w-4xl mx-auto px-4 pb-16 w-full">
...
function LandingExploreContent() {
...
function LandingHero({ signIn }: { signIn: (() => void) | undefined }) {
  const { signInWithGoogle } = useAuth();
  const handleSignIn = signIn === undefined ? signInWithGoogle : signIn;
  ...
  return (
    <section className="flex items-center justify-center px-4 py-20 relative">
      ...
      <div className="max-w-xl text-center animate-fade-in relative">
        ...
        <button onClick={handleSignIn} className="mt-10 inline-flex items-center gap-3 bg-white text-zinc-900 px-8 py-4 rounded-2xl font-semibold hover:bg-zinc-100 transition-all shadow-2xl shadow-white/10 hover:-translate-y-0.5">
